...
export function vec2solve(particles, constraints, barriers, iterations, attraction) {
...
export function vec1solve(particles, constraints, barriers, iterations) {
    return 0;
}
export function vec3solve(particles, constraints, barriers, iterations) {
    return 0;
}
...
function vec2surfacenormals(out1, input) {
    let inpn = vec2create();
...
function vec2collide2(velocity, wallstart, wallend, particlestart, particleend) {
...
//# sourceMappingURL=vec%20copy.js.map