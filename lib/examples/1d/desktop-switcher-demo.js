...
const anchor = new Particle(vec1fn, { x: getAnchorX() }, 0);
const dragPoint = new Particle(vec1fn, { x: getAnchorX() }, 1);
...
const spring = new Constraint(vec1fn, anchor, dragPoint, 1.0, SPRING_REST_LENGTH);
...
function commitDesktopSwitch(direction) {
...
requestAnimationFrame(drawFrame);
//# sourceMappingURL=desktop-switcher-demo.js.map