...
export declare function vec2solve(config: Config, iterations: number, particles: Particle<vec2>[], constraints: Constraint<vec2>[], barriers: Constraint<vec2>[]): number;
export declare function vec1solve(config: Config, iterations: number, particles: Particle<vec1>[], constraints: Constraint<vec1>[], barriers: Constraint<vec1>[]): number;
export declare function vec3solve(config: Config, iterations: number, particles: Particle<vec3>[], constraints: Constraint<vec3>[], barriers: Constraint<vec3>[]): number;
